...
void ControlPlanner::processFeedback(const visualization_msgs::InteractiveMarkerFeedbackConstPtr &feedback){
  if(feedback->event_type == visualization_msgs::InteractiveMarkerFeedback::MENU_SELECT){
    if(feedback->menu_entry_id == MenuItems::PLAN ||
      ...
      //   printf("plan and feed back path into egraph\n");
...
ControlPlanner::ControlPlanner(){
  ...
  torso_z = 0.3;
  // angles1 = monolithic_pr2_planner::DefaultLeftAngles;
  angles1 ={0.06024, 1.248526, 1.789070, -1.683386, -1.7343417, -0.0962141, -0.0864407};
